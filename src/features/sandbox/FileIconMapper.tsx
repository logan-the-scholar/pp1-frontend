                ...
                (() => {
                    switch (type) {
                        case FileType.TYPESCRIPT:
                            return (
                                <svg xmlns="http://www.w3.org/2000/svg" width={ICON_SIZE - 2} height={ICON_SIZE - 2} viewBox="0 0 128 128" fill="#007acc" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-blue-600">
                        ...
                        default:
                            return (
                                <svg xmlns="http://www.w3.org/2000/svg" width={ICON_SIZE} height={ICON_SIZE} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-text-icon lucide-text text-neutral-100">
