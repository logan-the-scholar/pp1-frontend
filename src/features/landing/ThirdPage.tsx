const ThirdPage = () => {
    const button_span = "text-neutral-500 content-center hover:-translate-y-[0.33em] mb-[2px] mr-[2px] hover:-translate-x-[0.2em] active:-translate-[1px] bg-[#121212] border border-neutral-500 -translate-y-[0.2em] -translate-x-[0.1em] transition-all duration-100 ease-in";
    ...
    return (
        <>
            ...
            <div id="page-3" className="h-[90vh] w-9/10 mx-auto flex-row">
                ...
                <div className="flex gap-1 mb-1 relative w-fit">
                    <button className="left-1/3 absolute bottom-full size-12 border border-neutral-500 key-sh-[#00000000] key-bg-[#00000000] key-button-[60deg] bg-transparent rounded-[8px]">
                        <span className={button_span}>
                            W
                        </span>
                    </button>
                    <button className="size-12 border border-neutral-500 key-sh-[#00000000] key-bg-[#00000000] key-button-[60deg] bg-transparent rounded-[8px]">
                        <span className={button_span}>
                            A
                        </span>
                    </button>
                ...
                <div className="flex gap-1">
                    <button className="h-12 key-sh-violet-900 key-bg-violet-700 key-button-[45deg] rounded-[8px] cursor-pointer">
                    ...
                    <button className="h-12 border border-white key-sh-[#00000000] key-bg-[#00000000] key-button-[60deg] bg-transparent rounded-[8px]">
                        <span className="hover:-translate-y-[0.33em] mb-[2px] mr-[2px] hover:-translate-x-[0.2em] active:translate-0 py-[0.6em] px-5 bg-[#121212] border border-white -translate-y-[0.2em] -translate-x-[0.1em] transition-all duration-100 ease-in">
                            _____________
                        </span>
                    </button>
                    <button className="h-12 key-sh-violet-900 key-bg-violet-700 key-button-[60deg] bg-violet-800 rounded-[8px] cursor-pointer">
                    ...
                    <button className="size-12 border border-neutral-500 key-sh-[#00000000] key-bg-[#00000000] key-button-[60deg] bg-transparent rounded-[8px]">
                        <span className="p-1.5 hover:-translate-y-[0.33em] mb-[2px] mr-[2px] hover:-translate-x-[0.2em] active:translate-0 border bg-[#121212] border-white -translate-y-[0.2em] -translate-x-[0.1em] transition-all duration-100 ease-in">
                            {/* <img className="w-full h-full" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg" /> */}
                            <svg stroke="#d4d4d4" viewBox="0 0 128 128">
                                <g fill="#d4d4d4">
                                    <path fill-rule="evenodd" clipRule="evenodd" d="M64 5.103c-33.347 0-60.388 27.035-60.388 60.388 0 26.682 17.303 49.317 41.297 57.303 3.017.56 4.125-1.31 4.125-2.905 0-1.44-.056-6.197-.082-11.243-16.8 3.653-20.345-7.125-20.345-7.125-2.747-6.98-6.705-8.836-6.705-8.836-5.48-3.748.413-3.67.413-3.67 6.063.425 9.257 6.223 9.257 6.223 5.386 9.23 14.127 6.562 17.573 5.02.542-3.903 2.107-6.568 3.834-8.076-13.413-1.525-27.514-6.704-27.514-29.843 0-6.593 2.36-11.98 6.223-16.21-.628-1.52-2.695-7.662.584-15.98 0 0 5.07-1.623 16.61 6.19C53.7 35 58.867 34.327 64 34.304c5.13.023 10.3.694 15.127 2.033 11.526-7.813 16.59-6.19 16.59-6.19 3.287 8.317 1.22 14.46.593 15.98 3.872 4.23 6.215 9.617 6.215 16.21 0 23.194-14.127 28.3-27.574 29.796 2.167 1.874 4.097 5.55 4.097 11.183 0 8.08-.07 14.583-.07 16.572 0 1.607 1.088 3.49 4.148 2.897 23.98-7.994 41.263-30.622 41.263-57.294C124.388 32.14 97.35 5.104 64 5.104z"></path>
                    ...
                    <button className="size-12 border border-neutral-500 key-sh-[#00000000] key-bg-[#00000000] key-button-[60deg] bg-transparent rounded-[8px]">
                        <span className="p-2 hover:-translate-y-[0.33em] mb-[2px] mr-[2px] hover:-translate-x-[0.2em] active:translate-0 border bg-[#121212] border-white -translate-y-[0.2em] -translate-x-[0.1em] transition-all duration-100 ease-in">
